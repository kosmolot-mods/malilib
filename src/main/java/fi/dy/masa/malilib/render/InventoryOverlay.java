...
public class InventoryOverlay
{
    ...
    public static void renderInventoryBackground(InventoryRenderType type, int x, int y, int slotsPerRow, int totalSlots, MinecraftClient mc, DrawContext drawContext)
    {
    ...
    public static void renderStackAt(ItemStack stack, float x, float y, float scale, MinecraftClient mc, DrawContext drawContext)
    {
        ...
        drawContext.getMatrices().translate(x, y, 0.f);
